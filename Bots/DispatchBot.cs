...
namespace Microsoft.BotBuilderSamples
{
    public class DispatchBot : ActivityHandler
    {
        ...
        {
            const string WelcomeText = "Welcome to issue Resolving bot, Please Type the issue you are facing";
        ...
        {
            turnContext.Activity.Text = intent;
            ...
            if (results.Any())
            {
                if(turnContext.Activity.Text == "ElasticSearch")
                {
                    ...
                    reply.SuggestedActions = new SuggestedActions()
                    {
                        ...
                        {
                            new CardAction() { Title = "Resolved", Type =       ActionTypes.ImBack,     Value = "Resolved", Image = "", ImageAltText = "Resolved" },
                        new CardAction() { Title = "not resolved", Type = ActionTypes.ImBack, Value = "Not Resolved", Image = "", ImageAltText = "Not Resolved" },
                        },
                    };
                ...
                else
                {
                    ...
                    {
                        var contactPerson = _botServices.AssistanceContact;
                        string message = (results.First().Answer + " "+contactPerson + " for further investigation");
;
                        await turnContext.SendActivityAsync(MessageFactory.Text(results.First().Answer + " " + contactPerson + " for further investigation"), cancellationToken);
                    }
                    else
                    {
